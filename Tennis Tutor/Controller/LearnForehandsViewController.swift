//
//  LearnForehandsViewController.swift
//  Tennis Tutor
//
...
class LearnForehandsViewController: UIViewController {
    ...
    @IBAction func playButtonPressed(_ sender: UIButton) {
        self.performSegue(withIdentifier: "forehandsToPlay", sender: self)
    }
    @IBAction func forehandsButtonPressed(_ sender: UIButton) {
        self.performSegue(withIdentifier: "forehandsToChoose", sender: self)
    }
    ...
    */
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "forehandsToChoose" {
            _ = segue.destination as! ChooseLearnViewController
        }
        if segue.identifier == "forehandsToPlay" {
