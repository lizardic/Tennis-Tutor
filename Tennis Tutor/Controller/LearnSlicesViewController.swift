//
//  LearnSlicesViewController.swift
//  Tennis Tutor
//
...
class LearnSlicesViewController: UIViewController {
    ...
    @IBAction func playButtonPressed(_ sender: UIButton) {
        self.performSegue(withIdentifier: "slicesToPlay", sender: self)
    }
    @IBAction func slicesButtonPressed(_ sender: UIButton) {
        self.performSegue(withIdentifier: "slicesToChoose", sender: self)
    }
    ...
    */
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "slicesToChoose" {
            _ = segue.destination as! ChooseLearnViewController
        }
        if segue.identifier == "slicesToPlay" {
